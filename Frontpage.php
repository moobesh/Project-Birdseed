...
<div class="container-fluid" id="input-boxes">
	<div class="row">
		...
		<div class="col-sm-3" id="alter">
			<h6>Alter</h6>
				<form action="./alter_name.php" method="POST" class="forms">
					<fieldset>
							<input type="text" name="alter_extension" placeholder="Enter extension"><label>*Required Field</label><br />
							<input type="text" name="alter_name" placeholder="Enter name"><br />
							<input type="text" name="alter_type" placeholder="Enter type"><br />
		...
		<div class="col-sm-3" id="delete">
			<h6>Delete</h6>
				<form method="POST" class="forms">
					<fieldset>
							<input type="text" name="delete_name" placeholder="Enter name"><br />
							<input type="text" name="delete_extension" placeholder="Enter extension"><br />
